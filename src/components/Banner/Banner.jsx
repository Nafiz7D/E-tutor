                ...
                <div className="grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0">
                    ...
                    <div className={`flex justify-start items-center ${reverse && "md:order-last md:justify-end"}`}>
                        <motion.img
                            ...
                            className='w-[400px] h-full object-cover' src={image} alt="" />
                    </div>
                    {/* banner text section */}
                    <div className='flex flex-col justify-center text-center md:text-left space-y-4 lg:max-w-[500px]'>
                        ...
                        <motion.p
                            ...
                            initial="hidden"
                            whileInView={"visible"}
                            className='text-xl lg:text-2xl font-semibold'>{title}</motion.p>
                        <motion.p
                        ...
                        <motion.div variants={SlideUp(1.1)}
                            initial="hidden"
                            whileInView={"visible"} className='flex justify-center md:justify-start'>
